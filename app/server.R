...
######################################################################################################################  
  ...
  datatrend <- reactive({
    ...
    output$TeamRankings <- DT::renderDataTable(formatRound(DT::datatable(rankings_final, 
                                                              ...
                                                              rownames = FALSE,
                                                              colnames = c('Team','Power Points','Years Active','Record',
                                                                     'FPD/G','Weeks High Scorer',
                                                                      'Weeks Low Scorer', 'Playoff Births','Byes', '1st Places','2nd Places', '3rd Places')),
                                                        c('Power_Points','Diff'),2))
    ...
    output$PlayoffData <- DT::renderDataTable(DT::datatable(playoffs_final, options = list(pageLength = 25, dom = 't'), 
                                                  ...
                                                  colnames = c('Team','Appearances','Wins','Loses','Byes',
                                                               'Championships','2nd Places','3rd Places')))
